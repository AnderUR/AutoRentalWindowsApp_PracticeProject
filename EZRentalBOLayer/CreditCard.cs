...
namespace EZRentalBOLayer
{
    public class CreditCard
    {
        ...
        private bool DALayer_InsertCreditCardOfACustomer(string customerkey)
        {
            //Temp stub method
            Console.WriteLine("DALayer_InsertCreditCardOfACustomer(string customerkey)" +
                              "Method simulating the Inserting of " +
                              "Credit Card data for a target customer " + customerkey + " to databse CreditCard TABLE" +
                              "and Customer_CreditCard Table");
            return true;
        }
        ...
        protected static List<CreditCard> DALayer_GetAllCreditCards()
        {
            ...
            catch (Exception objE)
            {
                ...
                throw new Exception("Unexpected Error in GetAllCreditCards(key) Method: {0} " + objE.Message);
            }
        }
    }
}